...
### programs
Содержит реализацию упрощенного калькулятора с построением дерева выражения. Программа состоит из токинезатора, парсера, программы вычисляющей выражение, реализации польской нотации.
